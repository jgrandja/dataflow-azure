 ...
 */
@RestController
@RequestMapping("/dataflow-api")
public class DataFlowApiController {

	@GetMapping("/view")
	public ServiceCallResponse view(JwtAuthenticationToken jwtAuthentication,
									HttpServletRequest request) {

		return fromDataFlowServer(jwtAuthentication, request);
	}

	private ServiceCallResponse fromDataFlowServer(JwtAuthenticationToken jwtAuthentication,
													 HttpServletRequest request) {

		ServiceCallResponse serviceCallResponse = new ServiceCallResponse();
		serviceCallResponse.setServiceName("dataflow-server");
